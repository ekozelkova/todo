/**
 * Created by Кэтрин on 20.10.2015.
 */
var i = 0;
...
var addTodo = function () {
    var newTodo = $("li")[0];
    console.log(newTodo);
    var label = $("label")[0];    //создаем label, где будет храниться текст юзера
    var checkbox = $("input")[0];     //создаем checkbox
    ...
    var textBox = $('#textBox')[0];     //получаем textBox
    ...
    var todoList = $('#todoList')[0];        //получаем весь todoList список
